                    ...
                    <div id='collapse{$i}' class='accordion-collapse collapse' aria-labelledby='heading{$i}' data-bs-parent='#accordionExample'>
                        ...
                        ";
                               ...
                               <div id='accordionBtn' style='text-align:right' >
                                   <button id='$uniqueLvId' type='button' value='$erpFacultyRole' class='btn btn-soft-success'>Approve</button>
                                   <button id='$uniqueLvId' type='button' value='$erpFacultyRole' class='btn btn-soft-danger'>Deny</button>
                               </div>
                           </div>
                           </div>";
    ...
    $("#accordionBtn button").click(function (e) {
        ...
        if (confirm('Are you sure you want to ' + btnName + '?')) {
            $.ajax({
                url: 'Functions.php',
                type: 'POST',
                data: { role: role, LeaveId: LeaveId, LeaveVal: LeaveVal, Approval: Approval, Function: "ApproveLeaveId" },
